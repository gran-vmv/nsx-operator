...
func (service *SecurityPolicyService) OperateRulesStore(sp *model.SecurityPolicy) error {
...
func (service *SecurityPolicyService) OperateGroupsStore(gs *[]model.Group) error {
